...
@section('subtitle', 'Perbarui detail rencana perjalanan, harga, dan fasilitas paket.')
    ...
    <form action="#" method="POST" enctype="multipart/form-data" class="w-full mx-auto pb-10">
        ...
        <div
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title_line2" required value="Kampoeng Naga Bermalam"
                            class="w-full px-4 py-3.5 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-[#0A0505] text-brand-text dark:text-white outline-none focus:ring-2 focus:ring-brand-accent/20">
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="quote" rows="2"
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-[#0A0505] text-brand-text dark:text-white outline-none focus:ring-2 focus:ring-brand-accent/20 italic custom-scrollbar">Bayangkan diri Anda berjalan menyusuri lorong-lorong pecinan kuno Sukabumi tepat saat lampion merah mulai berpendar di bawah langit senja.</textarea>
                </div>
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div>
                        ...
                        <input type="text" name="duration" value="2 Hari 1 Malam"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-brand-text dark:text-white mb-2 text-rose-500">Harga
                            Coret (Diskon)</label>
                        <input type="number" name="price_strike" value="1200000"
                    ...
                    <div>
                        <label class="block text-xs font-bold text-brand-text dark:text-white mb-2">Sisa Slot Promo
                            (Opsional)</label>
                        <input type="number" name="slots_left" value="4"
                        ...
                        <p class="text-[9px] text-brand-muted mt-1 leading-tight">Kosongkan jika paket tidak memiliki
                            batasan kuota.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="category" value="2 Hari 1 Malam"
                            placeholder="Contoh: Edukasi, Budaya, Kuliner..."
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-[#0A0505] text-brand-text dark:text-white outline-none text-sm focus:ring-2 focus:ring-brand-accent/20">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea name="included" rows="4"
                            class="w-full px-4 py-3 rounded-xl border border-emerald-200/50 bg-emerald-50/30 dark:bg-emerald-500/5 text-brand-text dark:text-white outline-none focus:ring-2 focus:ring-emerald-500/20 custom-scrollbar">Akomodasi Hotel Bintang 3, Tour Guide Berlisensi Resmi HPI, Kuliner Jalanan + Sarapan Dimsum</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="excluded" rows="4"
                            class="w-full px-4 py-3 rounded-xl border border-rose-200/50 bg-rose-50/30 dark:bg-rose-500/5 text-brand-text dark:text-white outline-none focus:ring-2 focus:ring-rose-500/20 custom-scrollbar">Transportasi dari/ke Kota Sukabumi, Biaya Minibar & Tambahan Laundry, Pengeluaran Pribadi</textarea>
            ...
            <div class="mb-10">
                ...
                <div class="mb-8">
                    <label class="block text-sm font-bold text-brand-text dark:text-white mb-3">Foto Utama Saat Ini <span
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                            <div class="md:col-span-2">
                                <input type="text" name="itinerary[0][title]" required
                                    value="Ketibaan & Petualangan Malam"
                            ...
                            <div>
                                <input type="text" name="itinerary[0][time_range]" value="Pukul 14:00 - 21:00"
                                    class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0A0505] text-sm focus:ring-2 focus:ring-brand-accent/20 outline-none">
                            </div>
                        </div>
                        ...
                        <div class="activities-container space-y-4 border-l-2 border-brand-accent/20 ml-4 pl-6">
                            ...
                            <div
                                ...
                                <button type="button" onclick="this.closest('.activity-item').remove()"
                                    class="absolute top-4 right-4 text-gray-400 hover:text-rose-500"><i
                                        class="iconoir-xmark"></i></button>
                                <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
                                    <div>
                                        <input type="text" name="itinerary[0][activities][0][time]" value="14:00"
                                        ...
                                        <select name="itinerary[0][activities][0][color]"
                                            ...
                                            <option value="brand-accent" selected>Warna Biasa</option>
                                    ...
                                    <div class="sm:col-span-3 space-y-3 pr-6">
                                        <input type="text" name="itinerary[0][activities][0][title]"
                                            value="Check-In Hotel & Welcome Tea"
                                        ...
                                        <textarea name="itinerary[0][activities][0][desc]" rows="2"
                                            class="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-black/20 text-xs outline-none custom-scrollbar">Layanan penjemputan atau pertemuan di lobi hotel pusat.</textarea>
                                    </div>
                                </div>
                            </div>

                            <div
                                class="activity-item bg-white dark:bg-[#1E1212] p-5 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm relative mt-4">
                                <div
                                    class="absolute -left-[35px] top-5 w-4 h-4 rounded-full bg-brand-gold ring-4 ring-white dark:ring-[#1E1212]">
                                </div>
                                <button type="button" onclick="this.closest('.activity-item').remove()"
                                    class="absolute top-4 right-4 text-gray-400 hover:text-rose-500"><i
                                        class="iconoir-xmark"></i></button>
                                <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
                                    <div>
                                        <input type="text" name="itinerary[0][activities][1][time]" value="19:00"
                                            class="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-black/20 text-xs outline-none">
                                        <select name="itinerary[0][activities][1][color]"
                                            class="w-full px-3 py-2 mt-2 rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-black/20 text-xs outline-none">
                                            <option value="brand-accent">Warna Biasa</option>
                                            <option value="brand-gold" selected>Warna Emas (Puncak)</option>
                                        </select>
                                    </div>
                                    <div class="sm:col-span-3 space-y-3 pr-6">
                                        <input type="text" name="itinerary[0][activities][1][title]"
                                            value="Simfoni Kuliner Malam"
                                            class="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-black/20 text-sm font-bold outline-none">
                                        <textarea name="itinerary[0][activities][1][desc]" rows="2"
                                            class="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-black/20 text-xs outline-none custom-scrollbar">Puncak acara di mana Anda akan disajikan deretan makanan legendaris dari kedai pusaka.</textarea>
                                    </div>
                                </div>
                            </div>
            ...
            <div
                ...
                <button type="submit"
                    ...
                    <i class="iconoir-check-circle"></i> Perbarui Paket Wisata
                </button>
                <a href="{{ route('admin.packages.index') }}"
